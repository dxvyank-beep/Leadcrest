...
export default function About() {
  ...
  return (
    <section id="about" ref={sectionRef} className="section-padding" style={{
      background: `radial-gradient(ellipse at 70% 30%, rgba(255,255,255,0.02) 0%, transparent 50%), linear-gradient(180deg, #000000 0%, #0c0c0c 100%)`,
    }}>
      <div className="max-w-[1200px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
        <div ref={leftRef}>
          ...
          <p className="text-neutral-400 text-lg sm:text-xl leading-relaxed mt-4">
